  ...
  return (
    <>
      ...
      <motion.p
        ...
        className="mt-4 text-white-800 text-[17px] max-w-3xl leading-[30px]"
      >
        I'm a Pre-final year computer science engineering student 
        who is learning computer science fundamentals and new technologies.
        I am currently working on web development, learning the latest technologies
        such as MERN, JavaScript, and TypeScript.
      </motion.p>
